...
const AppIcon: FC<Props> = ({ name, color = '#3b82f6', size = '48rpx' }) => {
  ...
  const map: Record<AppIconName, string> = {
    ...
    exam: toDataUri("M9 2a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2H9ZM4 6a2 2 0 0 1 2-2h1a1 1 0 0 1 0 2H6v14h12V6h-1a1 1 0 1 1 0-2h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6Zm4 5a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Zm0 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Z", fill),
    evaluation: toDataUri("M12 2l2.4 7.4h7.6l-6 4.6 2.3 7-6.3-4.6-6.3 4.6 2.3-7-6-4.6h7.6L12 2Zm0 4.5l-1.4 4.3H6.2l3.5 2.6-1.3 4.1 3.6-2.6 3.6 2.6-1.3-4.1 3.5-2.6h-4.4L12 6.5Z", fill)
  }
